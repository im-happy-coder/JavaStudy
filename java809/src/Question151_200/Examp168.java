...
//			java.util.function.Predicate 인터페이스의 단일 추상 메소드에 대해 올바른 설명은 무엇입니까?
//					A. 하나의 인수를 받아들이고 void를 반환합니다.
//					B. 하나의 인수를 받아들이고 부울을 반환합니다.
//					C. 하나의 인수를 받아들이고 항상 인수와 동일한 유형의 결과를 생성합니다.
//					D. 인수를 받아들이고 모든 데이터 유형의 결과를 생성합니다.
	
	// 답  B. It accepts one argument and returns boolean.
}
