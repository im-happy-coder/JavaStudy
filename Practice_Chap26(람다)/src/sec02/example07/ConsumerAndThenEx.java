...
public class ConsumerAndThenEx {
	...
	public static void main(String[] args) {
		...
		//Consumer<T>함수적 인터페이스는 매개값 p를 받아와서 단순히 소비하는 역할만 한다. 하여, accept()추상메서드를 람다식으로 정의했다.
		...
		//위의 정의된 2개의 함수적인터페이스 ConsumerA와 B를 가지고 아래와 같이 코딩을 하면,
		//ConsumerA가 먼저 실행이 되고, ConsumerB가 실행되어 출력결과가 나온다.
